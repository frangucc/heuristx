...
testData.webSites = [
	{
		id: 1,
		text: 'Delicious',
		image: 'js/testData/icons/Delicious.png',
		extra: 'icon by <a href="http://blog.iconspedia.com/icons/100-free-icons-weby-icon-set-192/" target="_blank">iconspedia.com</a>'
	},
	{
		id: 2,
		text: 'Digg',
		image: 'js/testData/icons/Digg.png',
		extra: 'icon by <a href="http://blog.iconspedia.com/icons/100-free-icons-weby-icon-set-192/" target="_blank">iconspedia.com</a>'
	},
	{
		id: 3,
		text: 'Flickr',
		image: 'js/testData/icons/Flickr.png',
		extra: 'icon by <a href="http://blog.iconspedia.com/icons/100-free-icons-weby-icon-set-192/" target="_blank">iconspedia.com</a>'
	},
	{
		id: 4,
		text: 'MySpace',
		image: 'js/testData/icons/MySpace.png',
		extra: 'icon by <a href="http://blog.iconspedia.com/icons/100-free-icons-weby-icon-set-192/" target="_blank">iconspedia.com</a>'
	},
	{
		id: 5,
		text: 'Youtube',
		image: 'js/testData/icons/Youtube.png',
		extra: 'icon by <a href="http://blog.iconspedia.com/icons/100-free-icons-weby-icon-set-192/" target="_blank">iconspedia.com</a>'
	},
	{
		id: 6,
		text: 'Reddit',
		image: 'js/testData/icons/Reddit.png',
		extra: 'icon by <a href="http://blog.iconspedia.com/icons/100-free-icons-weby-icon-set-192/" target="_blank">iconspedia.com</a>'
	},
	{
		id: 7,
		text: 'StumbleUpon',
		image: 'js/testData/icons/StumbleUpon.png',
		extra: 'icon by <a href="http://blog.iconspedia.com/icons/100-free-icons-weby-icon-set-192/" target="_blank">iconspedia.com</a>'
	},
	{
		id: 8,
		text: 'Twitter',
		image: 'js/testData/icons/Twitter.png',
		extra: 'icon by <a href="http://blog.iconspedia.com/icons/100-free-icons-weby-icon-set-192/" target="_blank">iconspedia.com</a>'
	}];
